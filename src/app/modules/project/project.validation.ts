...
// ----------------------------------------
export const updateBulkProjectValidationSchema = z.object({
  body: z.object({
...
// ----------------------------------------
// ✅ Single Project Operation Validation
// ----------------------------------------
...
// ----------------------------------------
// ✅ Bulk Project Operation Validation
// ----------------------------------------
export const bulkProjectOperationValidationSchema = z.object({
  body: z.object({
    ids: z.array(idSchema).nonempty('At least one project ID is required'),
  }),
});
